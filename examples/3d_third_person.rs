...
fn setup(
    ...
    commands.spawn((
        Mesh3d(meshes.add(Mesh::from(Plane3d::new(Vec3::Y, Vec2::splat(75.0))))),
    ...
    let player_id = commands
        .spawn((
            ...
            MeshMaterial3d(materials.add(StandardMaterial::from(Color::srgb(1.0, 0.8, 0.6)))),
            player_transform,
        ))
    ...
    let player_face_id = commands
        .spawn((
            Mesh3d(meshes.add(Mesh::from(Cuboid::new(1.0, 1.0, 1.0)))),
            MeshMaterial3d(materials.add(StandardMaterial::from(Color::srgb(0.0, 0.8, 0.6)))),
    ...
    for _ in 0..250 {
        commands.spawn((
            Mesh3d(meshes.add(Mesh::from(Cuboid::new(1.0, 1.0, 1.0)))),
            MeshMaterial3d(materials.add(StandardMaterial::from(Color::srgb(0.3, 0.7, 0.8)))),
            Transform {
